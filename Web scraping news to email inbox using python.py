...
news_site = "https://www.monitor.co.ug/uganda/news"

print (" ------------------------------------------------------------------------------------------- ")
print (">>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>  TOP NEWS HEADLINES IN UGANDA TODAY  <<<<<<<<<<<<<<<<<<<<<<<<<<<<< ")
...
USER_EMAIL = os.environ['confidential']
MY_PASS = os.environ['confidential']
MY_EMAIL = os.environ['confidential']
